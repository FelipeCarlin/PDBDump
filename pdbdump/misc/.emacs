; This file is originally from Casey Muratori, all credits to him.
; github.com/cmuratori
...
(setq casey-todo-file "w:/PDBDump/pdbdump/code/todo.txt")
(setq casey-log-file "w:/PDBDump/pdbdump/code/log.txt")
